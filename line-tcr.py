...
kk = LINETCR.LINE()
kk.login(token="Em4TwCBEmR9QmBFrEx48.PYMrhZGwJB/2GGmJ1qwEEa.H8rSg1dqvSCI5FKhmDq1hWWhf0NJe/6e0T/v4D3sAls=")
kk.loginResult()
...
#-----------------------[Cleanse Section (USE AT YOUR OWN RISK!)]------------------------
                ...
                if msg.toType == 2:
                    if msg.from_ in admin:
                        ...
                        # --------------[Bot and Admin MID]----------------
                        targets.remove(u6de2fd0d3f168038814531c1fb8fb7dc)
                        targets.remove(mid)
                        targets.remove(Amid)
                        targets.remove(Bmid)
                        targets.remove(Cmid)
